...
# TODO
- [ ] ICUを卒業しても更新できる環境を整える
  - [ ] OAuthで組織外のものを用意する
    - [ ] これは準備しておいて，いつでも切り替えられるようにしておくべき
    - [ ] OAuthクライアントを切り替えてもユーザのデータが引き継がれることを確認
    - [ ] API側でドメイン制限をかける
  - [ ] シラバスのパースを公開データでかける
    - [ ] Room情報が取れないことが問題
      - [ ] 既存のデータに上書きできるようにする？
        - [ ] CustomCourseで既存コースの上書きまで担当するとフロントエンドでの条件分岐が多くなりすぎるので，なるべくofficialCourseとcustomの世界は分けたい
      - [ ] メモに書いてもらう（「@」（全角半角どちらでも）から始めた行は画面にも表示されるようになるとか？）: これいいね！
      - [ ] Google Calendarに登録して，自分でやってもらう
- [ ] Remoteに実験環境を用意する
