...
- 実践するから学べるんだけど，ユーザがいる状態でデータを消したら取り返しがつかないので，そのせめぎあい．
  - バックアップをちゃんとしましょう．
  - 基礎を勉強しましょう．
- 2026-04-07T02:38:00UTC追記 仮説だが，Drizzleは本来必要のないときもmigrationファイルでuser tableの作り直しを行っている可能性がある
  - ためしにその作り直しを行っている行を削除すれば（少なくとも見掛け上は）うまくいっている
- 今後remoteにmigrationするときはフロントでその旨を告知して，フロントからの書き込みを制限すべき
  - Neonのブランチ機能って，こういうmigrationを別ブランチで行って最終的にデータをマージするイメージなのかな．俄然気になる．
  - 将来的には自分でlinuxからサーバー立ててバックアップ取りながらスケーリングとか最適化とかできるようになるといいよね．