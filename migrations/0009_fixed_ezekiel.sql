...
INSERT INTO `__new_courses`("id", "year", "rg_no", "status", "term", "course_code", "title_ja", "title_en", "instructor", "room", "language", "updated_at") SELECT "id", "year", "rg_no", "status", "term", "course_code", "title_ja", "title_en", "instructor", "room", "language", "updated_at" FROM `courses`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_custom_courses`("id", "user_id", "title", "instructor", "room", "day_of_week", "start_time", "end_time", "year", "term", "color_custom", "memo", "overridden_course_id", "created_at") SELECT "id", "user_id", "title", "instructor", "room", "day_of_week", "start_time", "end_time", "year", "term", "color_custom", "memo", "overridden_course_id", "created_at" FROM `custom_courses`;--> statement-breakpoint
