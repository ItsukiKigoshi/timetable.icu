...
export interface SearchFilters {
    ...
    export default function ExploreInterface({
        ...
        const [registeredIdList, setRegisteredIdList] = useState<number[]>(initialUserCourseIds);
            ...
            if (!user) {
                ...
                if (cached) {
                    try {
                        ...
                        setRegisteredIdList(prev => Array.from(new Set([...prev, ...localIds])));
                    } catch (e) {
        ...
        const registeredIds = useMemo(() => new Set(registeredIdList), [registeredIdList]);
            ...
            if (user) {
                ...
                try {
                    ...
                    if (data.action === "added") {
                        setRegisteredIdList(prev => Array.from(new Set([...prev, courseId])));
                    ...
                    console.error(e);
                    // ロールバック
                    setRegisteredIdList(prev => isRegistered ? [...prev, courseId] : prev.filter(id => id !== courseId));
