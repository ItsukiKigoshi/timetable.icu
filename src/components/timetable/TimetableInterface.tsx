...
import { LayoutGrid, List, CalendarPlus, Telescope } from "lucide-react";
          ...
          {coursesInSelectedSlot.length === 0 && (
            ...
            <div className="flex flex-col items-center justify-center gap-6 text-center">
              ...
              <div className="flex flex-col w-full gap-5">
                {/* コースを探すボタン */}
                <a
                  href={l(`/explore?slots=${selectedSlot?.day}-${selectedSlot?.period}`)}
                ...
                {/* カスタムコース作成ボタン */}
                <a
                  href={l(`/new?slots=${selectedSlot?.day}-${selectedSlot?.period}`)}
