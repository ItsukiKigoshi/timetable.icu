	...
	return (
		<LanguageProvider lang={lang}>
			<section className="flex flex-col w-full h-full select-none relative overflow-hidden">
				...
				<nav className="lg:hidden fixed bottom-16 left-2 z-50 flex bg-base-100 shadow-xl rounded-full border-2 border-base-300 p-1 gap-1 h-14 items-center">
					<button
				...
				<nav className="fixed lg:bottom-18 lg:right-4 bottom-16 right-2 z-50">
					...
					>
						...
						<span className="hidden lg:inline text-primary-content font-bold tracking-tight whitespace-nowrap">
