const ja = {
  ...
  "site.description":
    "ICU生の時間割・履修計画アプリの決定版の決定版．公式シラバス全コースの検索，Long 4-7等の特殊なコマ割対応，マルチデバイス同期で，国際基督教大学での学生生活をより快適に．ICU '27が愛を込めて開発中だよん．",
  ...
  // トースト, チーン!
  "toast.sync.ing": "データを同期しています...",
  "toast.sync.ed_reload": "同期完了！再読み込みします...",
  "toast.sync.fail": "同期に失敗しました．接続を確認してください．",
  ...
  "404.secret":
    "でも，ICUでは「迷うこと」も学びのひとつ．例えば，西太平洋を渡った遠洋航海者たちの交易を再現するためにキャンパスにいかだが出現することだってあります．",
...
const en = {
  ...
  "site.description": "The ultimate academic planning　tool for International Christian University students. Search official courses, manage Long 4-7 schedules, and sync your timetable across devices.",
  ...
  // Toast
  "toast.sync.ing": "Syncing...",
  "toast.sync.ed_reload": "Synced！Reloading...",
